    ...
    <x-jet-dropdown width="96">
        <x-slot name="trigger">
            <span class="relative inline-block cursor-pointer">
                ...
                @if (Cart::count())
                    <span
                        class="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none
        ...
        <x-slot name="content">
                        ...
                        <article class="flex-1">
                            ...
                            <div class="flex">
                                ...
                                @isset($item->options['size'])
                                    <p>{{ __(ucfirst($item->options['size'])) }}</p>
                                @endisset
                            </div>
                            <p>{{ $item->price }} &euro;</p>
                        </article>
            ...
            @if (Cart::count())
                <div class="p-2 px-3">
                    <p class="text-lg text-gray-700 mt-2 mb-3"><span class="font-bold">Total:
                        </span>{{ Cart::subtotal() }} &euro;</p>

<div x-data>
    <div>
        ...
        <select dusk="size-select" name="size-select" wire:model="size_id" class="form-control w-full">
    ...
    <div class="mt-2">
        ...
        <select dusk="color-select" name="color-select" wire:model="color_id" class="form-control w-full">
    ...
    <div class="flex">
        ...
        <div class="flex-1">
            <x-button x-bind:disabled="$wire.qty > $wire.quantity" x-bind:disabled="!$wire.quantity"
                ...
                color="orange" dusk="addItem-button">
